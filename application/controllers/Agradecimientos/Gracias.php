...
# Agregar nuevo mobiliario
	public function agregarMobiliario(){
		...
		if ($this->input->is_ajax_request()) {
			...
			$this->form_validation->set_rules('NOMBRE_SERVICIO', 'nombre', 'required');
			$this->form_validation->set_rules('DIRECCION', 'precio', 'required');
			$this->form_validation->set_rules('COSTO_ALQUILER', 'stock', 'required');
      $this->form_validation->set_rules('DESCRIPCION', 'descripcion', 'required');
			$this->form_validation->set_rules('CAPACIDAD', 'stock', 'required');
        ...
        if ($this->upload->do_upload('imagen')) {
	      ...
	      $ajax_data = array(
	        ...
	        'COSTO_ALQUILER' => $this->input->post('COSTO_ALQUILER'),
