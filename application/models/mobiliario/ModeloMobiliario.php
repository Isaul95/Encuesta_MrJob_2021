...
public function listarMobiliario(){
  $this->db->select('ID_SERVICIO,NOMBRE_SERVICIO,DIRECCION,COSTO_ALQUILER,CAPACIDAD,DESCRIPCION,NOMBRE_IMAGEN');
  $this->db->from('POLLERIA.SERVICIOS');
...
public function agregarMobiliario($data)
    {
        return $this->db->insert('POLLERIA.SERVICIOS', $data);
    }
